...
<html lang="en">
  ...
  <meta charset="UTF-8" />
    ...
    <meta name="author" content="Mohammad Hasim Ansari" />
    <title>Know Your ISM | Terms and Conditions</title>
    <link rel="icon" href="../public/img/kyi_logo_2.svg" type="image/icon type" />
    <link rel="stylesheet" href="terms and Conditions.css">
  </head>
  <body>
    <header>
      <h1 id="heading">
        Know <span id="your"> Your </span> ISM |
        <span id="terms-and-conditions">Terms and Conditions</span>
      </h1>
      <p class="last-edited">- Last updated: August 07, 2020</p>
      <p>
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to Know Your ISM, IIT(ISM) Dhanbad, Dhanbad,Jharkhand.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Know Your ISM, accessible from
          <a
            href="https://kyism.ga"
    ...
    <p>
      ...
      the law protects You. <a href="https://kyism.ga/privacy" target="_blank">Please read Our Privacy Policy carefully</a> before
      using Our Service.
    </p>
    ...
    <p>
      ...
      amount actually paid by You through the Service or ₹ 100  if You haven't
    ...
    <h1>Contact Us</h1>
    <p>
      We promise to strictly adhere to all the rules and conditions listed above. The data obtained by Us shall be kept confidential and not be misused in any personal manner. If You find some flaw or error on our part You can contact Us informally to rectify any shortcomings. Again, If you have any questions about these Terms and Conditions, You can
      contact us:
    </p>
    <ul>
      <li>By email at: sayhello@kyism.ml</li>
    </ul>
    </div>

    <img id="back-to-top" src="../public/img/back_to_top2.svg" alt="Up">
  </body>

  <script>
    const backToTop = document.querySelector("img");

    function showBackToTop () {
      if (window.scrollY > "500") {
        backToTop.style.right = '40px';
      } else if(window.scrollY < "500") {
        backToTop.style.right = '-10%';
      }
    }
    ...
    backToTop.addEventListener('click', scrollIt);
  </script>
</html>
